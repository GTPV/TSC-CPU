`define WORD_SIZE 16
`define MEMORY_BANDWIDTH 64
`define MEMORY_DELAY_READY 3'b100
...
///////////////////////////////////////////////////////////////////////////
// Cache size
`define cache_idx_bitlen 2
`define cache_block_offset_bitlen 2 // 4 words per block -> 2bits to index&select

`define block_00_idx_left (`MEMORY_BANDWIDTH-1)
`define block_00_idx_right (`block_00_idx_left-`WORD_SIZE + 1)
`define block_01_idx_left (`block_00_idx_right-1)
`define block_01_idx_right (`block_01_idx_left-`WORD_SIZE + 1)
`define block_10_idx_left (`block_01_idx_right-1)
`define block_10_idx_right (`block_10_idx_left-`WORD_SIZE + 1)
`define block_11_idx_left (`block_10_idx_right-1)
`define block_11_idx_right (0)
