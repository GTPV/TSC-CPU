...
///////////////////////////////////////////////////////////////////////////
// DMA enable/disable
`define DMA_ENABLED 1'b1
`define CYCLE_STEAL_ENABLED 1'b1

///////////////////////////////////////////////////////////////////////////
// DMA operation
`define DMA_WRITE_ADDRESS `WORD_SIZE'h01f4
`define DMA_WRITE_WORDLEN 12
...
`define BRANCH_PREDICTOR_ALWAYS_TAKEN 1'b0
`define BRANCH_PREDICTOR_HYSTERSIS (1'b1 && `BRANCH_PREDICTOR_ENABLED)
`define BRANCH_PREDICTOR_COUNTER (1'b0 && `BRANCH_PREDICTOR_ENABLED)
